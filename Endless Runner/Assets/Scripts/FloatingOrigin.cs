...
public class FloatingOrigin : MonoBehaviour
{
    ...
    void Start()
    {
        playerScript = GameObject.FindGameObjectWithTag("Player").GetComponent<PlayerMotor>();
    }
    void LateUpdate()
    {
        ...
        if (cameraPosition.magnitude > threshold)
        {
            ...
            foreach (Object o in objects)
            {
                ...
                Vector3 offset = new Vector3(GameObject.FindGameObjectWithTag("MainCamera").transform.position.x, 0, 0);
